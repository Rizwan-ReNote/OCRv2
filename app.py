...
# Sample question
question = '''Extract the exact text from the image, returning only the plain text content. Exclude any formatting, metadata, titles, subtitles, or table headers. Do not autocorrect, contract, or modify the words and letters. Return the text exactly as it appears in the image without any additional explanations. If no text is found, return '0', ensuring that no words are missed.'''
